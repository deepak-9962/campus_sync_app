-- Insert complete timetable for Semester 5 Computer Science and Engineering
-- This includes all 6 subjects mentioned by the user

-- First, ensure the subjects exist
...
-- Show all subjects being taught
SELECT DISTINCT 
    subject_code,
    (SELECT subject_name FROM subjects WHERE subjects.subject_code = class_schedule.subject_code LIMIT 1) as subject_name,
    faculty_name
FROM class_schedule 
WHERE department = 'Computer Science and Engineering' 
  AND semester = 5
