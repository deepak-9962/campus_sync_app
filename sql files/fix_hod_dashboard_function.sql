...
-- Test with both possible department name formats
SELECT 'Testing Computer Science and Engineering:' as test;
SELECT * FROM get_department_attendance_summary('Computer Science and Engineering');

SELECT 'Testing computer science engineering:' as test;
SELECT * FROM get_department_attendance_summary('computer science engineering');
